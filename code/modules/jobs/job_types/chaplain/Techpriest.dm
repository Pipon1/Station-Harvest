/datum/job/Techpriest
	title = JOB_TECHPRIEST
	...
	display_order = JOB_DISPLAY_ORDER_TECHPRIEST
...
/datum/outfit/job/chaplain
	name = "Techpriest"
	jobtype = /datum/job/Techpriest

	id_trim = /datum/id_trim/job/Techpriest
